...
@Entity
@Table(name = "MYNTRA_FORWARD_SETTLEMENT_REPORT")
public class MyntraForwardSettlementEntry {
    @Id
    ...
    @Column(name = "marketingCharges_prepaid")
    private String marketingChargesPrepaid;
    ...
    public String getMarketingChargesPrepaid() {
        return marketingChargesPrepaid;
    }

    public void setMarketingChargesPrepaid(String marketingChargesPrepaid) {
        this.marketingChargesPrepaid = marketingChargesPrepaid;
    }

    public String getMarketingChargesPostpaid() {
        return marketingChargesPostpaid;
    }
